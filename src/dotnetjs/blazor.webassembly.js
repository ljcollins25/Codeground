(() => {
    ...
    }), u(["copy", "cut", "paste"], a), u(["drag", "dragend", "dragenter", "dragleave", "dragover", "dragstart", "drop"], {
        createEventArgs: e => {
            return {
                ...f(t = e),
    ...
    }), u(["focus", "blur", "focusin", "focusout"], a), u(["keydown", "keyup", "keypress"], {
        createEventArgs: e => {
            return {
                key: (t = e).key,
                code: t.code,
    ...
    }), u(["contextmenu", "click", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "dblclick"], {
    ...
    class v {
        constructor(e, t) {
            ...
            for (const e of t) "eventcallback" === e.type && this._jsEventCallbackWrappers.set(e.name.toLowerCase(), new w)
        }
        setParameters(e) {
            const t = {},
                n = Object.entries(e || {}),
    ...
    function C(e, t, n) {
        return S(e, t.eventHandlerId, (() => A(e).invokeMethodAsync("DispatchEventAsync", t, n)))
    }
        ...
        dispatchGlobalEventToAllElements(e, t) {
            ...
            for (; o;) {
                ...
                if (m) {
                    ...
                    if (n && (u = f, d = t.type, !((u instanceof HTMLButtonElement || u instanceof HTMLInputElement || u instanceof HTMLTextAreaElement || u instanceof HTMLSelectElement) && k.hasOwnProperty(d) && u.disabled))) {
                        if (!a) {
                            const n = c(e);
                            s = (null == n ? void 0 : n.createEventArgs) ? n.createEventArgs(t) : {}, a = !0
                        }
                        O.hasOwnProperty(t.type) && t.preventDefault(), C(this.browserRendererId, {
                ...
                o = i || l ? void 0 : n.shift()
            }
            var u, d
        }
        getEventHandlerInfosForElement(e, t) {
            return e.hasOwnProperty(this.eventsCollectionKey) ? e[this.eventsCollectionKey] : t ? e[this.eventsCollectionKey] = new F : null
        }
    }
    D.nextEventDelegatorId = 0;
    class B {
        constructor(e) {
            this.globalListener = e, this.infosByEventHandlerId = {}, this.countByEventName = {}, i.push(this.handleEventNameAliasAdded.bind(this))
        }
        add(e) {
    ...
    const M = q("_blazorLogicalChildren"),
        j = q("_blazorLogicalParent"),
        L = q("_blazorLogicalEnd");
    ...
    function H(e, t, n) {
        const r = e;
        if (e instanceof Comment && G(r) && G(r).length > 0) throw new Error("Not implemented: inserting non-empty logical container");
    ...
    class ae {
        constructor(e) {
            this.rootComponentIds = new Set, this.childComponentLocations = {}, this.eventDelegator = new D(e), this.eventDelegator.notifyAfterClick((e => {
                if (!pe) return;
            ...
            for (let s = h; s < p; s++) {
                ...
                switch (h) {
                    ...
                    case t.removeAttribute: {
                        const t = U(r, l + d.siblingIndex(u));
        ...
        insertFrame(e, t, r, o, s, a, i) {
            ...
            switch (l) {
                ...
                case n.elementReferenceCapture:
                    if (r instanceof Element) return u = r, d = c.elementReferenceCaptureId(a), u.setAttribute(Z(d), ""), 0;
        ...
        insertElement(e, t, r, o, s, a, i) {
            ...
            for (let a = i + 1; a < m; a++) {
                ...
                if (c.frameType(i) !== n.attribute) {
                    H(u, r, o), f = !0, this.insertFrameRange(e, t, d, 0, s, a, m);
                    break
                }
                this.applyAttribute(e, t, u, i)
            }
            f || H(u, r, o), u instanceof HTMLOptionElement ? this.trySetSelectValueFromOptionElement(u) : Q in u && de(u, u._blazorDeferredValue)
        }
        trySetSelectValueFromOptionElement(e) {
            ...
            if (le(t)) e.selected = -1 !== t._blazorDeferredValue.indexOf(e.value);
                ...
                ue(t, e.value), delete t._blazorDeferredValue
            }
            return !0
        }
        ...
        insertMarkup(e, t, n, r) {
            const o = x(t, n),
                s = (a = e.frameReader.markupContent(r), z(t) ? (te.innerHTML = a || " ", te) : (ee.innerHTML = a || " ", ee.content));
            var a;
            let i = 0;
            for (; s.firstChild;) H(s.firstChild, o, i++)
        }
        ...
        tryApplyValueProperty(e, t, n) {
            ...
            switch (o && "INPUT" === t.tagName && (o = function(e, t) {
                    switch (t) {
                        case "time":
                            return 8 === e.length && e.endsWith("00") ? e.substring(0, 5) : e;
                        case "datetime-local":
                            return 19 === e.length && e.endsWith("00") ? e.substring(0, 16) : e;
                        default:
                            return e
                    }
                }(o, t.getAttribute("type"))), t.tagName) {
                case "INPUT":
                case "SELECT":
                case "TEXTAREA":
                    return o && t instanceof HTMLSelectElement && le(t) && (o = JSON.parse(o)), de(t, o), t._blazorDeferredValue = o, !0;
                case "OPTION":
        ...
        insertFrameRange(e, t, n, r, o, s, a) {
            ...
            for (let i = s; i < a; i++) {
                ...
                r += this.insertFrame(e, t, n, r, o, s, i), i += ie(e, s)
            }
            return r - i
        }
    }
    ...
    function he(e, t, n, r) {
        let o = fe[e];
        o || (o = fe[e] = new ae(e)), o.attachRootComponentToLogicalElement(n, t, r)
    }
    let pe = !1,
        ye = !1,
        ge = null;
    const be = {
        listenForNavigationEvents: function(e) {
            ge = e, ye || (ye = !0, window.addEventListener("popstate", (() => Ee(!1))))
        },
    ...
    function ve(e, t, n) {
        me = !0, n ? history.replaceState(null, "", e) : history.pushState(null, "", e), Ee(t)
    }
    async function Ee(e) {
        ge && await ge(location.href, e)
    }
    let _e;
    ...
    function Ne(e, t) {
        return e ? e.tagName === t ? e : Ne(e.parentElement, t) : null
    }
    ...
    const Ae = {
        ...
        Se = {
            ...
            dispose: function(e) {
                const t = Re[e._id];
                t && (t.intersectionObserver.disconnect(), t.mutationObserverBefore.disconnect(), t.mutationObserverAfter.disconnect(), e.dispose(), delete Re[e._id])
            }
        },
        Re = {};

    function Oe(e) {
        return e ? "visible" !== getComputedStyle(e).overflowY ? e : Oe(e.parentElement) : null
    }
    const ke = {
        ...
        Te = {
            ...
            registerCustomEventType: function(e, t) {
                ...
                if (t.browserEventName) {
                    ...
                    n ? n.push(e) : s.set(t.browserEventName, [e]), i.forEach((n => n(e, t.browserEventName)))
                }
                o.set(e, t)
            },
            rootComponents: b,
            _internal: {
                navigationManager: be,
                domWrapper: Ae,
                Virtualize: Se,
                PageTitle: ke,
                InputFile: De,
                ...
                receiveDotNetDataStream: function(t, n, r, o) {
                    ...
                    o ? (s.error(o), Fe.delete(t)) : 0 === r ? (s.close(), Fe.delete(t)) : s.enqueue(n.length === r ? n : n.subarray(0, r))
                },
                attachWebRendererInterop: function(t, n, r, o) {
                    if (_.has(t)) throw new Error(`Interop methods are already registered for renderer ${t}`);
                    _.set(t, n), Object.keys(r).length > 0 && function(t, n, r) {
    ...
    window.Blazor = Te;
    const Le = window.chrome && navigator.userAgent.indexOf("Edge") < 0;
    let Pe = !1,
        xe = !1;
    ...
    async function Je() {
        ...
        e && (e.style.display = "block"), $e || ($e = !0, document.querySelectorAll("#blazor-error-ui .reload").forEach((e => {
    ...
    const Ye = {
            start: function(t) {
                return new Promise(((n, r) => {
                    (function(e) {
                        Pe = !!e.bootConfig.resources.pdb, xe = e.bootConfig.debugBuild;
                        const t = navigator.platform.match(/^Mac/i) ? "Cmd" : "Alt";
                        He() && console.info(`Debugging hotkey: Shift+${t}+D (when application has focus)`), document.addEventListener("keydown", (e => {
                            e.shiftKey && (e.metaKey || e.altKey) && "KeyD" === e.code && (xe || Pe ? Le ? function() {
                        ...
                        function(o) {
                            ...
                            window.__wasmmodulecallback__ = () => {
                                window.Module = function(t, n, r) {
                                        ...
                                        let f, m;
                                        if (t.bootConfig.resources.runtime.hasOwnProperty(d) && (f = t.loadResource(d, "_framework/dotnet.timezones.blat", t.bootConfig.resources.runtime["dotnet.timezones.blat"], "globalization")), t.bootConfig.icuDataMode != ze.Invariant) {
                                            const e = t.startOptions.applicationCulture || navigator.languages && navigator.languages[0],
                                                n = function(e, t) {
                                                    if (!t || e.icuDataMode === ze.All) return "icudt.dat";
                                                    const n = t.split("-")[0];
                                        ...
                                        return s.instantiateWasm = (e, t) => ((async () => {
                                            ...
                                            Ge = cwrap("mono_wasm_add_assembly", null, ["string", "number", "number"]), MONO.loaded_files = [], f && async function(e) {
                                            ...
                                            }(m), c.forEach((e => h(e, tt(e.name, ".dll")))), l.forEach((e => h(e, e.name))), Te._internal.dotNetCriticalError = e => {
                                                s.printErr(BINDING.conv_string(e) || "(null)")
                                            }, Te._internal.getSatelliteAssemblies = e => {
                                                ...
                                                if (t.startOptions.applicationCulture || navigator.languages && navigator.languages[0], r) {
                                                    ...
                                                    return BINDING.js_to_mono_obj(e.then((e => (e.length && (Te._internal.readSatelliteAssemblies = () => {
                                            ...
                                            const e = {};
                                            Te._internal.getLazyAssemblies = n => {
                                                ...
                                                return BINDING.js_to_mono_obj(Promise.all([c, i]).then((t => (e.assemblies = t[0], e.pdbs = t[1], e.assemblies.length && (Te._internal.readLazyAssemblies = () => {
                                                    const {
                                                        assemblies: t
                                                    } = e;
                                            ...
                                            t.bootConfig.debugBuild && t.bootConfig.cacheBootResources && t.logToConsole(), t.purgeUnusedCacheEntriesAsync(), t.bootConfig.icuDataMode === ze.Sharded && (MONO.mono_wasm_setenv("__BLAZOR_SHARDED_ICU", "1"), t.startOptions.applicationCulture && MONO.mono_wasm_setenv("LANG", `${t.startOptions.applicationCulture}.UTF-8`));
                                            let r = "UTC";
                                            try {
                                                r = Intl.DateTimeFormat().resolvedOptions().timeZone
                                            } catch {}
                                            MONO.mono_wasm_setenv("TZ", r || "UTC"), t.bootConfig.modifiableAssemblies && MONO.mono_wasm_setenv("DOTNET_MODIFIABLE_ASSEMBLIES", t.bootConfig.modifiableAssemblies), t.bootConfig.aspnetCoreBrowserTools && MONO.mono_wasm_setenv("__ASPNETCORE_BROWSER_TOOLS", t.bootConfig.aspnetCoreBrowserTools), cwrap("mono_wasm_load_runtime", null, ["string", "number"])("appBinDir", He() ? -1 : 0), MONO.mono_wasm_runtime_ready(),
                                                function() {
                                                    const t = Qe("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "InvokeDotNet"),
                                                        n = Qe("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "BeginInvokeDotNet"),
                                                        r = Qe("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "EndInvokeJS"),
                                                        o = Qe("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "NotifyByteArrayAvailable");
                                                    e.attachDispatcher({
                                                        beginInvokeDotNetFromJS: (e, t, r, o, s) => {
                                                            if (nt(), !o && !t) throw new Error("Either assemblyName or dotNetObjectId must have a non null value.");
                                                        ...
                                                        invokeDotNetFromJS: (e, n, r, o) => (nt(), t(e || null, n, r ? r.toString() : null, o))
                                                    })
                                                }(), n()
                                        })), s;
                                        async function h(e, t) {
                                            ...
                                            try {
                                                ...
                                                new Uint8Array(Module.HEAPU8.buffer, s, r.length).set(r), Ge(t, s, r.length), MONO.loaded_files.push((o = e.url, qe.href = o, qe.href))
                                            } catch (e) {
                                                return void r(e)
                                            }
                                            var o;
            ...
            readUint64Field: function(e, t) {
                return function(e) {
                    ...
                    if (n > Ke) throw new Error(`Cannot read uint64 with high order part ${n}, because the result would exceed Number.MAX_SAFE_INTEGER.`);
                    return n * We + Module.HEAPU32[t]
                }(e + (t || 0))
            },
            ...
            readStringField: function(e, t, n) {
                ...
                let o;
                return Ve ? (o = Ve.stringCache.get(r), void 0 === o && (o = BINDING.conv_string(r), Ve.stringCache.set(r, o))) : o = BINDING.conv_string(r), o
            },
            readStructField: function(e, t) {
                return e + (t || 0)
            },
            beginHeapLock: function() {
                return nt(), Ve = new rt, Ve
            },
            invokeWhenHeapUnlocked: function(e) {
                Ve ? Ve.enqueuePostReleaseAction(e) : e()
            }
        },
    ...
    function nt() {
        if (Ve) throw new Error("Assertion failed - heap is currently locked")
    }
    class rt {
        constructor() {
        ...
        release() {
            var e;
            if (Ve !== this) throw new Error("Trying to release a lock which isn't current");
            for (Ve = null; null === (e = this.postReleaseActions) || void 0 === e ? void 0 : e.length;) this.postReleaseActions.shift()(), nt()
        }
    }
    class ot {
        constructor(e) {
            this.batchAddress = e, this.arrayRangeReader = st, this.arrayBuilderSegmentReader = at, this.diffReader = it, this.editReader = ct, this.frameReader = lt
        }
        updatedComponents() {
            return Me.readStructField(this.batchAddress, 0)
        }
        referenceFrames() {
            return Me.readStructField(this.batchAddress, st.structLength)
        }
        disposedComponentIds() {
            return Me.readStructField(this.batchAddress, 2 * st.structLength)
        }
        disposedEventHandlerIds() {
            return Me.readStructField(this.batchAddress, 3 * st.structLength)
        }
        updatedComponentsEntry(e, t) {
            return ut(e, t, it.structLength)
        }
        referenceFramesEntry(e, t) {
            return ut(e, t, lt.structLength)
        }
        disposedComponentIdsEntry(e, t) {
            const n = ut(e, t, 4);
            return Me.readInt32Field(n)
        }
        disposedEventHandlerIdsEntry(e, t) {
            const n = ut(e, t, 8);
            return Me.readUint64Field(n)
        }
    }
    const st = {
            structLength: 8,
            values: e => Me.readObjectField(e, 0),
            count: e => Me.readInt32Field(e, 4)
        },
        at = {
            structLength: 12,
            values: e => {
                const t = Me.readObjectField(e, 0),
                    n = Me.getObjectFieldsBaseAddress(t);
                return Me.readObjectField(n, 0)
            },
            offset: e => Me.readInt32Field(e, 4),
            count: e => Me.readInt32Field(e, 8)
        },
        it = {
            structLength: 4 + at.structLength,
            componentId: e => Me.readInt32Field(e, 0),
            edits: e => Me.readStructField(e, 4),
            editsEntry: (e, t) => ut(e, t, ct.structLength)
        },
        ct = {
            structLength: 20,
            editType: e => Me.readInt32Field(e, 0),
            siblingIndex: e => Me.readInt32Field(e, 4),
            newTreeIndex: e => Me.readInt32Field(e, 8),
            moveToSiblingIndex: e => Me.readInt32Field(e, 8),
            removedAttributeName: e => Me.readStringField(e, 16)
        },
        lt = {
            structLength: 36,
            frameType: e => Me.readInt16Field(e, 4),
            subtreeLength: e => Me.readInt32Field(e, 8),
            elementReferenceCaptureId: e => Me.readStringField(e, 16),
            componentId: e => Me.readInt32Field(e, 12),
            elementName: e => Me.readStringField(e, 16),
            textContent: e => Me.readStringField(e, 16),
            markupContent: e => Me.readStringField(e, 16),
            attributeName: e => Me.readStringField(e, 16),
            attributeValue: e => Me.readStringField(e, 24, !0),
            attributeEventHandlerId: e => Me.readUint64Field(e, 8)
        };

    function ut(e, t, n) {
        return Me.getArrayEntryPtr(e, t, n)
    }
    class dt {
        constructor(e, t, n) {
        ...
        logToConsole() {
            ...
            console.groupCollapsed(`%cblazor%c Loaded ${mt(o)} resources${s}`, "background: purple; color: white; padding: 1px 3px; border-radius: 3px;", "font-weight: bold;", "font-weight: normal;"), e.length && (console.groupCollapsed(`Loaded ${mt(n)} resources from cache`), console.table(this.cacheLoads), console.groupEnd()), t.length && (console.groupCollapsed(`Loaded ${mt(r)} resources from network`), console.table(this.networkLoads), console.groupEnd()), console.groupEnd()
        }
    ...
    class ht {
        static async initAsync(e) {
            Te._internal.getApplicationEnvironment = () => BINDING.js_string_to_mono_string(e.applicationEnvironment);
        ...
        resolveRegisteredElement(e) {
            ...
            return Number.isNaN(t) ? void 0 : function(e, t) {
                ...
                const n = e.parentNode,
                    r = P(n, !0),
                    o = G(r);
                return Array.from(n.childNodes).forEach((e => o.push(e))), e[j] = r, t && (e[L] = t, P(t)), P(e)
    ...
    const yt = /^\s*Blazor-Component-State:(?<state>[a-zA-Z0-9\+\/=]+)$/;
    ...
    function bt(e, t) {
        if (!e.hasChildNodes()) return [];
        const n = [],
            r = new It(e.childNodes);
        for (; r.next() && r.currentElement;) {
            const e = vt(r, t);
            if (e) n.push(e);
            else {
                const e = bt(r.currentElement, t);
    ...
    class Nt {
        constructor(e, t, n, r, o, s, a) {
            this.id = Nt.globalId++, this.type = e, this.assembly = r, this.typeName = o, this.parameterDefinitions = s, this.parameterValues = a, this.start = t, this.end = n
        }
    }
    Nt.globalId = 1;
    class Ct {
        ...
        async invokeAfterStartedCallbacks(e) {
            await N, await Promise.all(this.afterStartedCallbacks.map((t => t(e))))
        }
    }
    let At = !1;
    async function St(t) {
        if (At) throw new Error("Blazor has already started.");
        At = !0,
            function() {
                ...
                (function(e) {
                    return fe[e]
                })(e).eventDelegator.getHandler(t) && Ye.invokeWhenHeapUnlocked(n)
            }, Te._internal.applyHotReload = (t, n, r) => {
                e.invokeMethod("Microsoft.AspNetCore.Components.WebAssembly", "ApplyHotReloadDelta", t, n, r)
            }, Te._internal.getApplyUpdateCapabilities = () => e.invokeMethod("Microsoft.AspNetCore.Components.WebAssembly", "GetApplyUpdateCapabilities"), Te._internal.invokeJSFromDotNet = Rt, Te._internal.endInvokeDotNetFromJS = Ot, Te._internal.receiveByteArray = kt, Te._internal.retrieveByteArray = Dt;
        const n = je(Ye);
        Te.platform = n, Te._internal.renderBatch = (e, t) => {
            const n = Ye.beginHeapLock();
            try {
                ! function(e, t) {
                    const n = fe[e];
                    ...
                    me && (me = !1, window.scrollTo && window.scrollTo(0, 0))
                }(e, new ot(t))
            } finally {
                n.release()
            }
        };
        const r = Te._internal.navigationManager.getBaseURI,
            o = Te._internal.navigationManager.getLocationHref;
        Te._internal.navigationManager.getUnmarshalledBaseURI = () => BINDING.js_string_to_mono_string(r()), Te._internal.navigationManager.getUnmarshalledLocationHref = () => BINDING.js_string_to_mono_string(o()), Te._internal.navigationManager.listenForNavigationEvents((async (t, n) => {
            await e.invokeMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "NotifyLocationChanged", t, n)
        }));
        const s = null != t ? t : {},
            a = s.environment,
            i = Ue.initAsync(s.loadBootResource, a),
            c = function(e, t) {
                return function(e) {
                    const t = bt(e, "webassembly"),
                        n = [];
                    for (let e = 0; e < t.length; e++) {
                        const r = t[e],
                            o = new Nt(r.type, r.start, r.end, r.assembly, r.typeName, r.parameterDefinitions, r.parameterValues);
                        n.push(o)
                    }
            ...
            l = new pt(c);
        Te._internal.registeredComponents = {
        ...
        }, Te._internal.getPersistedState = () => BINDING.js_string_to_mono_string(gt(document) || ""), Te._internal.attachRootComponentToElement = (e, t, n) => {
            const r = l.resolveRegisteredElement(e);
            r ? he(n, r, t, !1) : function(e, t, n) {
                const r = "::after";
                let o = !1;
        ...
        const u = await i,
            ...
            }(u.bootConfig, s), [f] = await Promise.all([dt.initAsync(u.bootConfig, s || {}), ht.initAsync(u)]);
        try {
            await n.start(f)
        } catch (e) {
            throw new Error(`Failed to start platform. Reason: ${e}`)
        }
        n.callEntryPoint(f.bootConfig.entryAssembly), d.invokeAfterStartedCallbacks(Te)
    }

    function Rt(t, n, r, o) {
        const s = Ye.readStringField(t, 0),
            a = Ye.readInt32Field(t, 4),
            i = Ye.readStringField(t, 8),
            c = Ye.readUint64Field(t, 20);
        if (null !== i) {
            const n = Ye.readUint64Field(t, 12);
    ...
    function Dt() {
        if (null === et) throw new Error("Byte array not available for transfer");
        return BINDING.js_typed_array_to_array(et)
    }
    Te.start = St, document && document.currentScript && "false" !== document.currentScript.getAttribute("autostart") && St().catch((e => {
