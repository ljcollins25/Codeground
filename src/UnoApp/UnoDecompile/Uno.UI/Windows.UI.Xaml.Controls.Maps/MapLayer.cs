...
public class MapLayer : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty MapTabIndexProperty { get; } = DependencyProperty.Register("MapTabIndex", typeof(int), typeof(MapLayer), new FrameworkPropertyMetadata(0));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty VisibleProperty { get; } = DependencyProperty.Register("Visible", typeof(bool), typeof(MapLayer), new FrameworkPropertyMetadata(false));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty ZIndexProperty { get; } = DependencyProperty.Register("ZIndex", typeof(int), typeof(MapLayer), new FrameworkPropertyMetadata(0));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(MapLayer), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((MapLayer)s).OnDataContextChanged(e);
	}));
	...
	public MapLayer()
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapLayer", "MapLayer.MapLayer()");
	}
