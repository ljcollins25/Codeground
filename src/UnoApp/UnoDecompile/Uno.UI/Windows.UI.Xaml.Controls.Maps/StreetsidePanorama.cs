...
public class StreetsidePanorama : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public Geopoint Location
	{
		get
		{
			throw new NotImplementedException("The member Geopoint StreetsidePanorama.Location is not implemented in Uno.");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(StreetsidePanorama), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((StreetsidePanorama)s).OnDataContextChanged(e);
	}));
	...
	{
		throw new NotImplementedException("The member IAsyncOperation<StreetsidePanorama> StreetsidePanorama.FindNearbyAsync(Geopoint location) is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static IAsyncOperation<StreetsidePanorama> FindNearbyAsync(Geopoint location, double radiusInMeters)
	{
		throw new NotImplementedException("The member IAsyncOperation<StreetsidePanorama> StreetsidePanorama.FindNearbyAsync(Geopoint location, double radiusInMeters) is not implemented in Uno.");
	}
