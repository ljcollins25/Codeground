...
public class MapInputEventArgs : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(MapInputEventArgs), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((MapInputEventArgs)s).OnDataContextChanged(e);
	}));
	...
	{
		new MapInputEventArgs(null, default(Point));
	}
