...
public class MapElement : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public int MapTabIndex
	{
		get
		{
			return (int)GetValue(MapTabIndexProperty);
		}
		set
		{
			SetValue(MapTabIndexProperty, value);
		}
	}
	...
	public string MapStyleSheetEntryState
	{
		get
		{
			return (string)GetValue(MapStyleSheetEntryStateProperty);
		}
		set
		{
			SetValue(MapStyleSheetEntryStateProperty, value);
		}
	}
	...
	public string MapStyleSheetEntry
	{
		get
		{
			return (string)GetValue(MapStyleSheetEntryProperty);
		}
		set
		{
			SetValue(MapStyleSheetEntryProperty, value);
		}
	}
	...
	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty VisibleProperty { get; } = DependencyProperty.Register("Visible", typeof(bool), typeof(MapElement), new FrameworkPropertyMetadata(false));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty ZIndexProperty { get; } = DependencyProperty.Register("ZIndex", typeof(int), typeof(MapElement), new FrameworkPropertyMetadata(0));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty MapTabIndexProperty { get; } = DependencyProperty.Register("MapTabIndex", typeof(int), typeof(MapElement), new FrameworkPropertyMetadata(0));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty MapStyleSheetEntryProperty { get; } = DependencyProperty.Register("MapStyleSheetEntry", typeof(string), typeof(MapElement), new FrameworkPropertyMetadata((object)null));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty MapStyleSheetEntryStateProperty { get; } = DependencyProperty.Register("MapStyleSheetEntryState", typeof(string), typeof(MapElement), new FrameworkPropertyMetadata((object)null));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty TagProperty { get; } = DependencyProperty.Register("Tag", typeof(object), typeof(MapElement), new FrameworkPropertyMetadata((object)null));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty IsEnabledProperty { get; } = DependencyProperty.Register("IsEnabled", typeof(bool), typeof(MapElement), new FrameworkPropertyMetadata(false));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(MapElement), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((MapElement)s).OnDataContextChanged(e);
	}));
	...
	public MapElement()
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapElement", "MapElement.MapElement()");
	}
