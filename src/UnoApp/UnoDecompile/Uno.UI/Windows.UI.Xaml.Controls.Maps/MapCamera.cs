...
public class MapCamera : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public double Roll
	{
		get
		{
			throw new NotImplementedException("The member double MapCamera.Roll is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "double MapCamera.Roll");
		}
	}
	...
	public double Pitch
	{
		get
		{
			throw new NotImplementedException("The member double MapCamera.Pitch is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "double MapCamera.Pitch");
		}
	}
	...
	public Geopoint Location
	{
		get
		{
			throw new NotImplementedException("The member Geopoint MapCamera.Location is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "Geopoint MapCamera.Location");
		}
	}
	...
	public double Heading
	{
		get
		{
			throw new NotImplementedException("The member double MapCamera.Heading is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "double MapCamera.Heading");
		}
	}
	...
	public double FieldOfView
	{
		get
		{
			throw new NotImplementedException("The member double MapCamera.FieldOfView is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "double MapCamera.FieldOfView");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(MapCamera), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((MapCamera)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "MapCamera.MapCamera(Geopoint location)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public MapCamera(Geopoint location, double headingInDegrees)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "MapCamera.MapCamera(Geopoint location, double headingInDegrees)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public MapCamera(Geopoint location, double headingInDegrees, double pitchInDegrees)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "MapCamera.MapCamera(Geopoint location, double headingInDegrees, double pitchInDegrees)");
	}
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapCamera", "MapCamera.MapCamera(Geopoint location, double headingInDegrees, double pitchInDegrees, double rollInDegrees, double fieldOfViewInDegrees)");
	}
