...
public class MapModel3D : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(MapModel3D), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((MapModel3D)s).OnDataContextChanged(e);
	}));
	...
	public MapModel3D()
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Maps.MapModel3D", "MapModel3D.MapModel3D()");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static IAsyncOperation<MapModel3D> CreateFrom3MFAsync(IRandomAccessStreamReference source)
	{
		throw new NotImplementedException("The member IAsyncOperation<MapModel3D> MapModel3D.CreateFrom3MFAsync(IRandomAccessStreamReference source) is not implemented in Uno.");
	}
	...
	{
		throw new NotImplementedException("The member IAsyncOperation<MapModel3D> MapModel3D.CreateFrom3MFAsync(IRandomAccessStreamReference source, MapModel3DShadingOption shadingOption) is not implemented in Uno.");
	}
