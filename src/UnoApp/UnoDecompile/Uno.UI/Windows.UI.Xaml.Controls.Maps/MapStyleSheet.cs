...
public class MapStyleSheet : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(MapStyleSheet), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((MapStyleSheet)s).OnDataContextChanged(e);
	}));
	...
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.Aerial() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet AerialWithOverlay()
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.AerialWithOverlay() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet RoadLight()
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.RoadLight() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet RoadDark()
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.RoadDark() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet RoadHighContrastLight()
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.RoadHighContrastLight() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet RoadHighContrastDark()
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.RoadHighContrastDark() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet Combine(IEnumerable<MapStyleSheet> styleSheets)
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.Combine(IEnumerable<MapStyleSheet> styleSheets) is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static MapStyleSheet ParseFromJson(string styleAsJson)
	{
		throw new NotImplementedException("The member MapStyleSheet MapStyleSheet.ParseFromJson(string styleAsJson) is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static bool TryParseFromJson(string styleAsJson, out MapStyleSheet styleSheet)
	{
		throw new NotImplementedException("The member bool MapStyleSheet.TryParseFromJson(string styleAsJson, out MapStyleSheet styleSheet) is not implemented in Uno.");
	}
