...
public class Geometry : DependencyObject, IDisposable, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static Geometry Empty
	{
		get
		{
			throw new NotImplementedException("The member Geometry Geometry.Empty is not implemented in Uno.");
		}
	}
	...
	public static double StandardFlatteningTolerance
	{
		get
		{
			throw new NotImplementedException("The member double Geometry.StandardFlatteningTolerance is not implemented in Uno.");
		}
	}
	...
	public static DependencyProperty TransformProperty { get; } = DependencyProperty.Register("Transform", typeof(Transform), typeof(Geometry), new FrameworkPropertyMetadata((object)null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(Geometry), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((Geometry)s).OnDataContextChanged(e);
	}));
	...
	internal virtual SvgElement GetSvgElement()
	{
		throw new NotSupportedException(string.Format("{0} is not implemented for {1}.", "GetSvgElement", this));
	}

	internal virtual IFormattable ToPathData()
	{
		throw new NotSupportedException(string.Format("{0} is not implemented for {1}.", "ToPathData", this));
	}
