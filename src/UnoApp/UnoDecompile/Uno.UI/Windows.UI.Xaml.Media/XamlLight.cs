...
public class XamlLight : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public CompositionLight CompositionLight
	{
		get
		{
			throw new NotImplementedException("The member CompositionLight XamlLight.CompositionLight is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "CompositionLight XamlLight.CompositionLight");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(XamlLight), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((XamlLight)s).OnDataContextChanged(e);
	}));
	...
	public XamlLight()
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "XamlLight.XamlLight()");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	protected virtual string GetId()
	{
		throw new NotImplementedException("The member string XamlLight.GetId() is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	protected virtual void OnConnected(UIElement newElement)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "void XamlLight.OnConnected(UIElement newElement)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	protected virtual void OnDisconnected(UIElement oldElement)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "void XamlLight.OnDisconnected(UIElement oldElement)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static void AddTargetElement(string lightId, UIElement element)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "void XamlLight.AddTargetElement(string lightId, UIElement element)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static void RemoveTargetElement(string lightId, UIElement element)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "void XamlLight.RemoveTargetElement(string lightId, UIElement element)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static void AddTargetBrush(string lightId, Brush brush)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "void XamlLight.AddTargetBrush(string lightId, Brush brush)");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static void RemoveTargetBrush(string lightId, Brush brush)
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.XamlLight", "void XamlLight.RemoveTargetBrush(string lightId, Brush brush)");
	}
