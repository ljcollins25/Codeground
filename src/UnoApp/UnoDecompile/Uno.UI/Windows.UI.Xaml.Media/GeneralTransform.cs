...
public class GeneralTransform : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(GeneralTransform), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((GeneralTransform)s).OnDataContextChanged(e);
	}));
	...
	{
		TryTransform(point, out var outPoint);
		return outPoint;
	}
