...
public class PointKeyFrame : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty KeyTimeProperty { get; } = DependencyProperty.Register("KeyTime", typeof(KeyTime), typeof(PointKeyFrame), new FrameworkPropertyMetadata(default(KeyTime)));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty ValueProperty { get; } = DependencyProperty.Register("Value", typeof(Point), typeof(PointKeyFrame), new FrameworkPropertyMetadata(default(Point)));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(PointKeyFrame), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((PointKeyFrame)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Media.Animation.PointKeyFrame", "PointKeyFrame.PointKeyFrame()");
	}
