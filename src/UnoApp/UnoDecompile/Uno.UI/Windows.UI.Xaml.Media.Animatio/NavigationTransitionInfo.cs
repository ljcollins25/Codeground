...
public class NavigationTransitionInfo : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(NavigationTransitionInfo), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((NavigationTransitionInfo)s).OnDataContextChanged(e);
	}));
	...
	{
		((NavigationTransitionInfo)s).OnTemplatedParentChanged(e);
	}));
