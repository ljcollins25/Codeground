...
public abstract class DoubleKeyFrame : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty ValueProperty { get; } = DependencyProperty.Register("Value", typeof(double), typeof(DoubleKeyFrame), new FrameworkPropertyMetadata(0.0));
	...
	public static DependencyProperty KeyTimeProperty { get; } = DependencyProperty.Register("KeyTime", typeof(KeyTime), typeof(DoubleKeyFrame), new FrameworkPropertyMetadata(default(KeyTime)));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(DoubleKeyFrame), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((DoubleKeyFrame)s).OnDataContextChanged(e);
	}));
	...
	public DoubleKeyFrame(double value)
		: this()
	{
		Value = value;
	}

	public DoubleKeyFrame(double value, KeyTime keyTime)
		: this()
	{
		Value = value;
		KeyTime = keyTime;
