...
public abstract class ColorKeyFrame : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty ValueProperty { get; } = DependencyProperty.Register("Value", typeof(Color), typeof(ColorKeyFrame), new FrameworkPropertyMetadata(default(Color)));
	...
	public static DependencyProperty KeyTimeProperty { get; } = DependencyProperty.Register("KeyTime", typeof(KeyTime), typeof(ColorKeyFrame), new FrameworkPropertyMetadata(default(KeyTime)));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ColorKeyFrame), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ColorKeyFrame)s).OnDataContextChanged(e);
	}));
	...
	internal virtual IEasingFunction GetEasingFunction()
	{
		return null;
	}
