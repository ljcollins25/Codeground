...
public class ObjectKeyFrame : DependencyObject, IKeyFrame<object>, IKeyFrame, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty KeyTimeProperty { get; } = DependencyProperty.Register("KeyTime", typeof(KeyTime), typeof(ObjectKeyFrame), new FrameworkPropertyMetadata(null));
	...
	public static DependencyProperty ValueProperty { get; } = DependencyProperty.Register("Value", typeof(object), typeof(ObjectKeyFrame), new FrameworkPropertyMetadata(null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ObjectKeyFrame), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ObjectKeyFrame)s).OnDataContextChanged(e);
	}));
	...
	{
		((ObjectKeyFrame)s).OnTemplatedParentChanged(e);
	}));
