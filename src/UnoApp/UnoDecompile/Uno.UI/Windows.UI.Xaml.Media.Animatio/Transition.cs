...
public class Transition : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(Transition), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((Transition)s).OnDataContextChanged(e);
	}));
	...
	private void OnElementLoaded(object sender, RoutedEventArgs e)
	{
		...
		AttachToStoryboardAnimation(storyboard, (IFrameworkElement)sender, TimeSpan.Zero);
		storyboard.Begin();
	}
