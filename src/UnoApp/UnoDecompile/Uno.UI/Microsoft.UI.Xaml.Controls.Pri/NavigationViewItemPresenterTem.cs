...
public class NavigationViewItemPresenterTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty IconWidthProperty { get; } = DependencyProperty.Register("IconWidth", typeof(double), typeof(NavigationViewItemPresenterTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public static DependencyProperty SmallerIconWidthProperty { get; } = DependencyProperty.Register("SmallerIconWidth", typeof(double), typeof(NavigationViewItemPresenterTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(NavigationViewItemPresenterTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((NavigationViewItemPresenterTemplateSettings)s).OnDataContextChanged(e);
	}));
