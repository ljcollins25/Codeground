...
internal class ResourceAccessor
{
	...
	{
		return ResourceLoader.GetForViewIndependentUse().GetString(resourceName);
	}
	...
	public static LoadedImageSurface GetImageSurface(string assetName, Size imageSize)
	{
		...
		Uri getImageUri()
		{
			...
			{
				return new Uri("ms-resource://Microsoft.UI.Xaml.3.0/Files/Microsoft.UI.Xaml/Assets/" + assetName + ".png");
			}
	...
	{
		if (!control.Resources.HasKey(key))
		{
			return Application.Current.Resources.Lookup(key);
		}
