...
public class ProgressBarTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty ContainerAnimationStartPositionProperty { get; } = DependencyProperty.Register("ContainerAnimationStartPosition", typeof(double), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double ContainerAnimationStartPosition
	{
		...
		set
		{
			SetValue(ContainerAnimationStartPositionProperty, value);
		}
	}

	public static DependencyProperty ContainerAnimationEndPositionProperty { get; } = DependencyProperty.Register("ContainerAnimationEndPosition", typeof(double), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double ContainerAnimationEndPosition
	{
		...
		set
		{
			SetValue(ContainerAnimationEndPositionProperty, value);
		}
	}

	public static DependencyProperty ContainerAnimationStartPosition2Property { get; } = DependencyProperty.Register("ContainerAnimationStartPosition2", typeof(double), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double ContainerAnimationStartPosition2
	{
		get
		{
			return (double)GetValue(ContainerAnimationStartPosition2Property);
		}
		set
		{
			SetValue(ContainerAnimationStartPosition2Property, value);
		}
	}

	public static DependencyProperty ContainerAnimationEndPosition2Property { get; } = DependencyProperty.Register("ContainerAnimationEndPosition2", typeof(double), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double ContainerAnimationEndPosition2
	{
		get
		{
			return (double)GetValue(ContainerAnimationEndPosition2Property);
		}
		set
		{
			SetValue(ContainerAnimationEndPosition2Property, value);
		}
	}

	public static DependencyProperty ContainerAnimationMidPositionProperty { get; } = DependencyProperty.Register("ContainerAnimationMidPosition", typeof(double), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double ContainerAnimationMidPosition
	{
		...
		set
		{
			SetValue(ContainerAnimationMidPositionProperty, value);
		}
	}

	public static DependencyProperty IndicatorLengthDeltaProperty { get; } = DependencyProperty.Register("IndicatorLengthDelta", typeof(double), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double IndicatorLengthDelta
	{
		...
		set
		{
			SetValue(IndicatorLengthDeltaProperty, value);
		}
	}

	public static DependencyProperty ClipRectProperty { get; } = DependencyProperty.Register("ClipRect", typeof(RectangleGeometry), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata((object)null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ProgressBarTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ProgressBarTemplateSettings)s).OnDataContextChanged(e);
	}));
	...
	{
		((ProgressBarTemplateSettings)s).OnTemplatedParentChanged(e);
	}));
