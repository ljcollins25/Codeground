...
public class PagerControlTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public IList<object> Pages
	{
		get
		{
			return (IList<object>)GetValue(PagesProperty);
		}
		set
		{
	...
	public static DependencyProperty PagesProperty { get; } = DependencyProperty.Register("Pages", typeof(IList<object>), typeof(PagerControlTemplateSettings), new FrameworkPropertyMetadata(null));
	...
	public IList<object> NumberPanelItems
	{
		get
		{
			return (IList<object>)GetValue(NumberPanelItemsProperty);
		}
		set
		{
			SetValue(NumberPanelItemsProperty, value);
		}
	}

	public static DependencyProperty NumberPanelItemsProperty { get; } = DependencyProperty.Register("NumberPanelItems", typeof(IList<object>), typeof(PagerControlTemplateSettings), new FrameworkPropertyMetadata(null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(PagerControlTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((PagerControlTemplateSettings)s).OnDataContextChanged(e);
	}));
