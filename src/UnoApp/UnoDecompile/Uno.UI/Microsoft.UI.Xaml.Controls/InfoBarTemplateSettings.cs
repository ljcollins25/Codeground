...
public class InfoBarTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty IconElementProperty { get; } = DependencyProperty.Register("IconElement", typeof(IconElement), typeof(InfoBarTemplateSettings), new FrameworkPropertyMetadata(null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(InfoBarTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((InfoBarTemplateSettings)s).OnDataContextChanged(e);
	}));
