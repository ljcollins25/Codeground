...
public class TabViewItemTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty IconElementProperty { get; } = DependencyProperty.Register("IconElement", typeof(IconElement), typeof(TabViewItemTemplateSettings), new FrameworkPropertyMetadata(null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(TabViewItemTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((TabViewItemTemplateSettings)s).OnDataContextChanged(e);
	}));
