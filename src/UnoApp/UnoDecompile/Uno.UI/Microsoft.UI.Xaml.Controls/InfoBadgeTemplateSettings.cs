...
public class InfoBadgeTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty IconElementProperty { get; } = DependencyProperty.Register("IconElement", typeof(IconElement), typeof(InfoBadgeTemplateSettings), new FrameworkPropertyMetadata(null));
	...
	public CornerRadius InfoBadgeCornerRadius
	{
		get
		{
			return (CornerRadius)GetValue(InfoBadgeCornerRadiusProperty);
		}
		set
		{
			SetValue(InfoBadgeCornerRadiusProperty, value);
		}
	}

	public static DependencyProperty InfoBadgeCornerRadiusProperty { get; } = DependencyProperty.Register("InfoBadgeCornerRadius", typeof(CornerRadius), typeof(InfoBadgeTemplateSettings), new FrameworkPropertyMetadata(default(CornerRadius)));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(InfoBadgeTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((InfoBadgeTemplateSettings)s).OnDataContextChanged(e);
	}));
