...
public class TreeViewItemTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public Visibility CollapsedGlyphVisibility
	{
		get
		{
			return (Visibility)GetValue(CollapsedGlyphVisibilityProperty);
		}
		internal set
		{
			SetValue(CollapsedGlyphVisibilityProperty, value);
		}
	}
	...
	public int DragItemsCount
	{
		get
		{
			return (int)GetValue(DragItemsCountProperty);
		}
		internal set
		{
			SetValue(DragItemsCountProperty, value);
		}
	}
	...
	public Visibility ExpandedGlyphVisibility
	{
		get
		{
			return (Visibility)GetValue(ExpandedGlyphVisibilityProperty);
		}
		internal set
		{
			SetValue(ExpandedGlyphVisibilityProperty, value);
		}
	}
	...
	public Thickness Indentation
	{
		get
		{
			return (Thickness)GetValue(IndentationProperty);
		}
		internal set
		{
	...
	public static DependencyProperty CollapsedGlyphVisibilityProperty { get; } = DependencyProperty.Register("CollapsedGlyphVisibility", typeof(Visibility), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(Visibility.Collapsed));
	...
	public static DependencyProperty ExpandedGlyphVisibilityProperty { get; } = DependencyProperty.Register("ExpandedGlyphVisibility", typeof(Visibility), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(Visibility.Collapsed));
