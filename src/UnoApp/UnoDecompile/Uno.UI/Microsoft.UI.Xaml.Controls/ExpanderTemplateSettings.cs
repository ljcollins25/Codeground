...
public class ExpanderTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty ContentHeightProperty { get; } = DependencyProperty.Register("ContentHeight", typeof(double), typeof(ExpanderTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public double NegativeContentHeight
	{
		get
		{
			return (double)GetValue(NegativeContentHeightProperty);
		}
		internal set
		{
			SetValue(NegativeContentHeightProperty, value);
		}
	}

	public static DependencyProperty NegativeContentHeightProperty { get; } = DependencyProperty.Register("NegativeContentHeight", typeof(double), typeof(ExpanderTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ExpanderTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ExpanderTemplateSettings)s).OnDataContextChanged(e);
	}));
