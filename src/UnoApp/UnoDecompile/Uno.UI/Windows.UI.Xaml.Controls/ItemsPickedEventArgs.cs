...
public class ItemsPickedEventArgs : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public IList<object> AddedItems
	{
		get
		{
			throw new NotImplementedException("The member IList<object> ItemsPickedEventArgs.AddedItems is not implemented in Uno.");
		}
	}
	...
	public IList<object> RemovedItems
	{
		get
		{
			throw new NotImplementedException("The member IList<object> ItemsPickedEventArgs.RemovedItems is not implemented in Uno.");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ItemsPickedEventArgs), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ItemsPickedEventArgs)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.ItemsPickedEventArgs", "ItemsPickedEventArgs.ItemsPickedEventArgs()");
	}
