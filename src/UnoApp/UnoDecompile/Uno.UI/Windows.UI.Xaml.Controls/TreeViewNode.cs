...
public class TreeViewNode : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public IList<TreeViewNode> Children
	{
		get
		{
			throw new NotImplementedException("The member IList<TreeViewNode> TreeViewNode.Children is not implemented in Uno.");
		}
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public int Depth => (int)GetValue(DepthProperty);

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public bool HasChildren => (bool)GetValue(HasChildrenProperty);
	...
	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty ContentProperty { get; } = DependencyProperty.Register("Content", typeof(object), typeof(TreeViewNode), new FrameworkPropertyMetadata((object)null));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty DepthProperty { get; } = DependencyProperty.Register("Depth", typeof(int), typeof(TreeViewNode), new FrameworkPropertyMetadata(0));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty HasChildrenProperty { get; } = DependencyProperty.Register("HasChildren", typeof(bool), typeof(TreeViewNode), new FrameworkPropertyMetadata(false));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty IsExpandedProperty { get; } = DependencyProperty.Register("IsExpanded", typeof(bool), typeof(TreeViewNode), new FrameworkPropertyMetadata(false));
	...
	public TreeViewNode()
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.TreeViewNode", "TreeViewNode.TreeViewNode()");
	}
