...
public class AutoSuggestBoxSuggestionChosenEventArgs : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(AutoSuggestBoxSuggestionChosenEventArgs), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((AutoSuggestBoxSuggestionChosenEventArgs)s).OnDataContextChanged(e);
	}));
