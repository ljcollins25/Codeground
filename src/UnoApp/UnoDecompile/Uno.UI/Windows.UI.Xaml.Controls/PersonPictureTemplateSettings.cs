...
public class PersonPictureTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public ImageBrush ActualImageBrush
	{
		get
		{
			return (ImageBrush)GetValue(ActualImageBrushProperty);
		}
		internal set
		{
			SetValue(ActualImageBrushProperty, value);
		}
	}

	public static DependencyProperty ActualImageBrushProperty { get; } = DependencyProperty.Register("ActualImageBrush", typeof(ImageBrush), typeof(PersonPictureTemplateSettings), new FrameworkPropertyMetadata(null));
	...
	public string ActualInitials
	{
		get
		{
			return (string)GetValue(ActualInitialsProperty);
		}
		internal set
		{
			SetValue(ActualInitialsProperty, value);
		}
	}

	public static DependencyProperty ActualInitialsProperty { get; } = DependencyProperty.Register("ActualInitials", typeof(string), typeof(PersonPictureTemplateSettings), new FrameworkPropertyMetadata(""));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(PersonPictureTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((PersonPictureTemplateSettings)s).OnDataContextChanged(e);
	}));
