...
public class TimePickedEventArgs : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public TimeSpan NewTime
	{
		get
		{
			throw new NotImplementedException("The member TimeSpan TimePickedEventArgs.NewTime is not implemented in Uno.");
		}
	}
	...
	public TimeSpan OldTime
	{
		get
		{
			throw new NotImplementedException("The member TimeSpan TimePickedEventArgs.OldTime is not implemented in Uno.");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(TimePickedEventArgs), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((TimePickedEventArgs)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.TimePickedEventArgs", "TimePickedEventArgs.TimePickedEventArgs()");
	}
