...
public class TreeViewItemTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public Visibility CollapsedGlyphVisibility => (Visibility)GetValue(CollapsedGlyphVisibilityProperty);

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public int DragItemsCount => (int)GetValue(DragItemsCountProperty);

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public Visibility ExpandedGlyphVisibility => (Visibility)GetValue(ExpandedGlyphVisibilityProperty);

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public Thickness Indentation => (Thickness)GetValue(IndentationProperty);

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty CollapsedGlyphVisibilityProperty { get; } = DependencyProperty.Register("CollapsedGlyphVisibility", typeof(Visibility), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(Visibility.Visible));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty DragItemsCountProperty { get; } = DependencyProperty.Register("DragItemsCount", typeof(int), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(0));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty ExpandedGlyphVisibilityProperty { get; } = DependencyProperty.Register("ExpandedGlyphVisibility", typeof(Visibility), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(Visibility.Visible));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty IndentationProperty { get; } = DependencyProperty.Register("Indentation", typeof(Thickness), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(default(Thickness)));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(TreeViewItemTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((TreeViewItemTemplateSettings)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.TreeViewItemTemplateSettings", "TreeViewItemTemplateSettings.TreeViewItemTemplateSettings()");
	}
