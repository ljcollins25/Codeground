...
public class InkToolbarCustomPen : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(InkToolbarCustomPen), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((InkToolbarCustomPen)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.InkToolbarCustomPen", "InkToolbarCustomPen.InkToolbarCustomPen()");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public InkDrawingAttributes CreateInkDrawingAttributes(Brush brush, double strokeWidth)
	{
		throw new NotImplementedException("The member InkDrawingAttributes InkToolbarCustomPen.CreateInkDrawingAttributes(Brush brush, double strokeWidth) is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	protected virtual InkDrawingAttributes CreateInkDrawingAttributesCore(Brush brush, double strokeWidth)
	{
		throw new NotImplementedException("The member InkDrawingAttributes InkToolbarCustomPen.CreateInkDrawingAttributesCore(Brush brush, double strokeWidth) is not implemented in Uno.");
	}
