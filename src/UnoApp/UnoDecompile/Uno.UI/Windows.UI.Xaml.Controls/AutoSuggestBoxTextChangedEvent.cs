...
public class AutoSuggestBoxTextChangedEventArgs : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public static DependencyProperty ReasonProperty { get; } = DependencyProperty.Register("Reason", typeof(AutoSuggestionBoxTextChangeReason), typeof(AutoSuggestBoxTextChangedEventArgs), new FrameworkPropertyMetadata(AutoSuggestionBoxTextChangeReason.UserInput));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(AutoSuggestBoxTextChangedEventArgs), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((AutoSuggestBoxTextChangedEventArgs)s).OnDataContextChanged(e);
	}));
	...
	{
		((AutoSuggestBoxTextChangedEventArgs)s).OnTemplatedParentChanged(e);
	}));
	...
	{
		return string.Equals(_originalText, _owner.Text);
	}
