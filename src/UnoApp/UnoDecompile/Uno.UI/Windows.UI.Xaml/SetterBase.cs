...
public abstract class SetterBase : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public bool IsSealed
	{
		get
		{
			throw new NotImplementedException("The member bool SetterBase.IsSealed is not implemented in Uno.");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(SetterBase), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((SetterBase)s).OnDataContextChanged(e);
	}));
	...
	[EditorBrowsable(EditorBrowsableState.Never)]
	public void set_Property(string name)
	{
		OnStringPropertyChanged(name);
	}
