...
public class VisualTransition : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public EasingFunctionBase GeneratedEasingFunction
	{
		get
		{
			throw new NotImplementedException("The member EasingFunctionBase VisualTransition.GeneratedEasingFunction is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.VisualTransition", "EasingFunctionBase VisualTransition.GeneratedEasingFunction");
		}
	}
	...
	public Duration GeneratedDuration
	{
		get
		{
			throw new NotImplementedException("The member Duration VisualTransition.GeneratedDuration is not implemented in Uno.");
		}
		set
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.VisualTransition", "Duration VisualTransition.GeneratedDuration");
		}
	}
	...
	public static DependencyProperty StoryboardProperty { get; } = DependencyProperty.Register("Storyboard", typeof(Storyboard), typeof(VisualTransition), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.LogicalChild));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(VisualTransition), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((VisualTransition)s).OnDataContextChanged(e);
	}));
	...
	private void EnsureMaterialized()
	{
		if (LazyBuilder != null)
		{
			Action lazyBuilder = LazyBuilder;
			LazyBuilder = null;
			lazyBuilder();
