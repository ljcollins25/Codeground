...
public class AppBarButtonTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	internal static DependencyProperty KeyboardAcceleratorTextMinWidthProperty { get; } = DependencyProperty.Register("KeyboardAcceleratorTextMinWidth", typeof(double), typeof(AppBarButtonTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(AppBarButtonTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((AppBarButtonTemplateSettings)s).OnDataContextChanged(e);
	}));
	...
	{
		((AppBarButtonTemplateSettings)s).OnTemplatedParentChanged(e);
	}));
