...
public class ComboBoxTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public double DropDownClosedHeight
	{
		get
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.ComboBoxTemplateSettings", "ComboBoxTemplateSettings.DropDownClosedHeight");
			return 0.0;
		}
	}
	...
	public double DropDownOffset
	{
		get
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.ComboBoxTemplateSettings", "ComboBoxTemplateSettings.DropDownOffset");
			return 0.0;
		}
	}
	...
	public double DropDownOpenedHeight
	{
		get
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.ComboBoxTemplateSettings", "ComboBoxTemplateSettings.DropDownOpenedHeight");
			return 0.0;
		}
	}
	...
	public AnimationDirection SelectedItemDirection
	{
		get
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.ComboBoxTemplateSettings", "ComboBoxTemplateSettings.SelectedItemDirection");
	...
	public double DropDownContentMinWidth
	{
		get
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.ComboBoxTemplateSettings", "ComboBoxTemplateSettings.DropDownContentMinWidth");
			return 0.0;
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ComboBoxTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ComboBoxTemplateSettings)s).OnDataContextChanged(e);
	}));
	...
	{
		((ComboBoxTemplateSettings)s).OnTemplatedParentChanged(e);
	}));
