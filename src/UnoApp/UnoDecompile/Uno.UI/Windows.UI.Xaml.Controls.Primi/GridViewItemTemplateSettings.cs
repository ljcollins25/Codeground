...
public class GridViewItemTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public int DragItemsCount
	{
		get
		{
			ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.GridViewItemTemplateSettings", "GridViewItemTemplateSettings.DragItemsCount");
			return 0;
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(GridViewItemTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((GridViewItemTemplateSettings)s).OnDataContextChanged(e);
	}));
