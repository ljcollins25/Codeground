...
public class ToolTipTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public double FromHorizontalOffset
	{
		get
		{
			throw new NotImplementedException("The member double ToolTipTemplateSettings.FromHorizontalOffset is not implemented in Uno.");
		}
	}
	...
	public double FromVerticalOffset
	{
		get
		{
			throw new NotImplementedException("The member double ToolTipTemplateSettings.FromVerticalOffset is not implemented in Uno.");
		}
	}
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(ToolTipTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((ToolTipTemplateSettings)s).OnDataContextChanged(e);
	}));
