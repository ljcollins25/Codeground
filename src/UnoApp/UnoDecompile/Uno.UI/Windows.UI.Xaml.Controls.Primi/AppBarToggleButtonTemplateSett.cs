...
public class AppBarToggleButtonTemplateSettings : DependencyObject, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	public double KeyboardAcceleratorTextMinWidth
	{
		get
		{
			return (double)GetValue(KeyboardAcceleratorTextMinWidthProperty);
		}
		internal set
		{
			SetValue(KeyboardAcceleratorTextMinWidthProperty, value);
		}
	}

	internal static DependencyProperty KeyboardAcceleratorTextMinWidthProperty { get; } = DependencyProperty.Register("KeyboardAcceleratorTextMinWidth", typeof(double), typeof(AppBarToggleButtonTemplateSettings), new FrameworkPropertyMetadata(0.0));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(AppBarToggleButtonTemplateSettings), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((AppBarToggleButtonTemplateSettings)s).OnDataContextChanged(e);
	}));
