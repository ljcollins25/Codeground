...
public class JumpListItemForegroundConverter : DependencyObject, IValueConverter, IDependencyObjectStoreProvider, IWeakReferenceProvider
{
	...
	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty DisabledProperty { get; } = DependencyProperty.Register("Disabled", typeof(Brush), typeof(JumpListItemForegroundConverter), new FrameworkPropertyMetadata((object)null));


	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public static DependencyProperty EnabledProperty { get; } = DependencyProperty.Register("Enabled", typeof(Brush), typeof(JumpListItemForegroundConverter), new FrameworkPropertyMetadata((object)null));
	...
	public static DependencyProperty DataContextProperty { get; } = DependencyProperty.Register("DataContext", typeof(object), typeof(JumpListItemForegroundConverter), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.Inherits, delegate(DependencyObject s, DependencyPropertyChangedEventArgs e)
	{
		((JumpListItemForegroundConverter)s).OnDataContextChanged(e);
	}));
	...
	{
		ApiInformation.TryRaiseNotImplemented("Windows.UI.Xaml.Controls.Primitives.JumpListItemForegroundConverter", "JumpListItemForegroundConverter.JumpListItemForegroundConverter()");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public object Convert(object value, Type targetType, object parameter, string language)
	{
		throw new NotImplementedException("The member object JumpListItemForegroundConverter.Convert(object value, Type targetType, object parameter, string language) is not implemented in Uno.");
	}

	[NotImplemented(new string[] { "__ANDROID__", "__IOS__", "NET461", "__WASM__", "__SKIA__", "__NETSTD_REFERENCE__", "__MACOS__" })]
	public object ConvertBack(object value, Type targetType, object parameter, string language)
	{
		throw new NotImplementedException("The member object JumpListItemForegroundConverter.ConvertBack(object value, Type targetType, object parameter, string language) is not implemented in Uno.");
	}
